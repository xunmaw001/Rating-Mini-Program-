		...
		<view class="container">
			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					:style='{"boxShadow":"0 0 2rpx rgba(0,0,0,.8)","margin":"0 ","borderColor":"#000000","backgroundColor":"#000000","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
				</view>
   	 <view style="margin-top: 10rpx;"></view>

					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#000000","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
						...
						<view class="text" :style='{"color":"#96b8c4","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.zhutizixunCollectionValue}}</view>
					</view>
            ...
            <view class="bottom-content cu-bar bg-white tabbar border shop">
                ...
                <view style="text-align: right;">
					...
					<!-- <button @tap="onSubmit" style="margin-right: 10upx;" class="cu-btn bg-red round shadow-blur"
                            :style="{width:'auto',borderRadius:'8rpx',height:'80rpx',fontSize:'28rpx',color:'#000000',backgroundColor:btnColor[3],borderColor:btnColor[3]}">立即购买</button>-->
                </view>
            </view>
		</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('zhutizixunCollection', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.zhutizixunCollectionPhoto ? this.detail.zhutizixunCollectionPhoto.split(",") : [];
			},
