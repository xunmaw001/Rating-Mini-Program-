    ...
    <view class="content">
        <view class="forget-bg">
            <view class="forget-card"
                  :style='{"boxShadow":"0 0 0px #59f43e","backgroundColor":"#000000","borderColor":"#ccc","borderRadius":"20rpx","borderStyle":"solid","borderWidth":"0px"}'>
                ...
                <view class="login-input login-margin-b">
                    <picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;"
                        ...
                        <view class="uni-input"
                              :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#96b8c4","textAlign":"center"}'>
                            {{options[index]}}</view>
                    </picker>
                </view>
            </view>
        ...
        <view class="forget-btn">
            <button class="landing"
                    :style='{"borderColor":"#ccc","backgroundColor":"#96b8c4","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
